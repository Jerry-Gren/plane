 ...
 * VM map, object, resident hash, VM page, PMM allocator, active pmap, and kmem
 * readiness locks now exist as early boundaries. This still is not a fully
 * concurrent SMP fault path: it lacks TLB shootdown, pmap pageable state,
 * pager/COW synchronization, and user-map fault ownership.
 */
